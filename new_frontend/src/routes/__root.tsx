...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      // (placeholders kept to satisfy scaffold)
      { property: "app:name", content: "Sahayak" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700;900&family=Inter:wght@400;500;600;700&family=Noto+Sans+Kannada:wght@400;500;600;700;900&display=swap",
      },
    ],
  }),
